...
from utils import download_file, unzip_file, clean_dir
from config import work_dir


class TdxGbbq:
    def _get_latest_gbbq(self):
        url = "http://www.tdx.com.cn/products/data/data/dbf/gbbq.zip"
        gbbq_dir = work_dir.rstrip("/") + "/latest_gbbq"
        clean_dir(gbbq_dir)
        download_file(url=url, target_path=gbbq_dir, check_url=False)
        unzip_file(file_path=gbbq_dir + "/gbbq.zip", target_path=gbbq_dir + "/g")
        return gbbq_dir + "/g/gbbq"
